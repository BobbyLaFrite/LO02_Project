		...
		do {
			if (isAccused) {//ETRE ACCUSE
				...
				do { //on boucle tant que le choix n'est qu'un affichage
					this.userInput=UserInterface.getInstance().chooseBetween("Voulez-vous r\u00e9veler votre role (reveal) ou jouer une carte (play). (show hand/show player)", "reveal,play,show hand,show player", false);
