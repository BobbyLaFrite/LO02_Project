...
public class HoockedNose extends Card{
	...
	public NextPlayer activateWitch(Player actuPlayer){
		Player prevPlayer = Game.getInstance().getPrevPlayer();
		Card stealedCard;
		if (prevPlayer.getHand().isEmpty()) {
			System.out.println("Hoocked Nose - Witch :\n Le joueur qui vous a accusé n'as plus de carte mais vous prenez le tour !");
		}else {
			...
			System.out.println("Hoocked Nose - Witch :\n Vous avez volé la carte "+stealedCard.getName()+" et vous prenez le tour !");
	...
	public NextPlayer activateHunt(Player actuPlayer){ 
		...
		if (target.getHand().isEmpty()) {
			...
			System.out.println("Hoocked Nose - Witch :\n Vous avez volé la carte "+stealedCard.getName()+" et le tour passe à"+target.getName()+"!");
